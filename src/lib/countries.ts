export interface Country {
  ...
  code: string
  name: string
  /** Flag emoji derived from the code's regional indicator symbols. */
  flag: string
}

// Full ISO 3166-1 alpha-2 code list. Names and flags are derived from these,
// so the shipped data is just ~250 two-letter strings.
const COUNTRY_CODES = [
...
/** Turns "US" into 🇺🇸 by mapping each letter to its regional indicator. */
